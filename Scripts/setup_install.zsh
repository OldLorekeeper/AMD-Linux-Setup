...
if [[ -z "${GIT_NAME:-}" ]]; then
    ...
    GIT_NAME=${GIT_NAME:-OldLoresetopt ERR_EXIT NO_UNSET PIPE_FAIL EXTENDED_GLOB
...
umount -R /mnt
print -P "%F{yellow}System ready. Please remove installation media and reboot.%f"setopt ERR_EXIT NO_UNSET PIPE_FAIL EXTENDED_GLOB
