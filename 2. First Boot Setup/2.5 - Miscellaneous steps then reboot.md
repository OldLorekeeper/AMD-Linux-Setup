...
Add widget then right click plasmoid and configure:

```
>>> Shortcut: Meta+C (c for chat)
>>> Icon: https://github.com/OldLorekeeper/AMD-Linux-Setup/blob/main/5.%20Resources/Icons/Miscellaneous/Google_Gemini_icon_2025small.png
```
