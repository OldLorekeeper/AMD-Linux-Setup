...
Edit the HDR script to match your hardware:

Bash

```
kate ~/Obsidian/AMD-Linux-Setup/5-Resources/Sunshine/sunshine_hdr.zsh
```

_Update variables `MONITOR`, `STREAM_MODE`, and `DEFAULT_MODE` based on the output from kscreen-doctor._

**2. Web UI Setup**

Navigate to the Sunshine Web UI (`https://localhost:47990`) > **Applications** > **Desktop** (or your specific game app).

Scroll to **Command Preparations** and add the following (replace `[user]` with your username):
...
- **Undo Command:**
    ...
    sudo /home/[user]/Obsidian/AMD-Linux-Setup/5-Resources/Sunshine/sunshine-gpu-boost.zsh
    ```
