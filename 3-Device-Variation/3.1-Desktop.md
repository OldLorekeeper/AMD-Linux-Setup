...
You must manually add relevant `Do` and `Undo` commands in Sunshine Web UI for each application
...
| DO                                                         | Undo                                              |
| ---------------------------------------------------------- | ------------------------------------------------- |
| ```<br>sudo /usr/local/bin/sunshine-gpu-boost start<br>``` | ```sudo /usr/local/bin/sunshine-gpu-boost stop``` |
|                                                            |                                                   |
